<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        ...
        <form method="post" name="frm" action="Oldinsert2.php"enctype="multipart/form-data" id="form1" onsubmit="return check();" >
            ...
            <tr>
             ...
             <input type="hidden" name="Op_ID" >
                ...
                <a href="TableforEmployeeOld.php"><input type="button"  value="ตรวจสอบข้อมูลผู้สูงอายุ"></a>
