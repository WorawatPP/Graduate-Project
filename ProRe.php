 <?php
    ...
    $Pd_ID = $_GET['Pd_ID']; /* รับค่า Pd_ID มาจากหน้า Product.php */
...
<html>
    ...
    <style>
     ...
     <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
         <form method="post" name="frm" action="ProReInUp.php" enctype="multipart/form-data" id="form1" onsubmit="return check();">
             <fieldset style="border:3px solid black" class="detail">
             <legend>เบิกสิ่งของบริจาค</legend>
            ...
            <tr>
                ...
                <a href="Product.php"><input name="button" type="button" value="ย้อนกลับ"></a>
                 </td>
            </tr>
        </table>
            </fieldset>
