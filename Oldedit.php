...
<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        <form method="post" action="Oldupdate.php"enctype="multipart/form-data" id="form1" >
            ...
            <tr> 
                <td>15.วันที่เข้าพัก:</td><td><input type="datetime-local" name="Op_Checkin"  value="<?php echo $row ['Op_Checkin'];?>"></td>
            </tr>
            <tr>
            ...
            <tr>
             <td>20.ค่าคอเรสเตอรอล:</td><td><input type="number" name="Op_CHO"  size="3" value="<?php echo $row ['Op_CHO'];?>"></td>   
                ...
                <a href="TableforAdminOld.php"><input type="button" value="ย้อนกลับ"></a>
                </div>
            </fieldset>
        </form>
    </body>
