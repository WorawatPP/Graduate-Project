<?php
    ...
    $op_id = $_GET['Op_ID']; /* รับค่า Op_ID มาจากหน้า TableforAdminOld.php */
...
<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        <form method="post" name="frm" action="QueueOldinsert.php" enctype="multipart/form-data" id="form1" onsubmit="return check();">
            <fieldset style="border:3px solid black" class="detail">
            <legend>นัดพบแพทย์</legend>
            ...
            <tr>
                ...
                <a href="TableforAdminOld.php"><input name="button" type="button" value="ย้อนกลับ"></a>
                 </td>
            </tr>
        </table>
            </fieldset>
