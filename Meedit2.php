...
<html>
    ...
    font-size: 20px;
     ...
     <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
         ...
         <form method="post" action="Meupdate2.php" enctype="multipart/form-data" id="form1">
            
            
             <fieldset style="border:3px solid black" class="detail"><legend>เพิ่มจำนานยา</legend>
                
                
                
                
            <table style="font-size: 25px;color: black" align="center">
            ...
            <tr>
                ...
                <a href="TableEmployee3M.php"><input name="button" type="button" value="ย้อนกลับ"></a>
