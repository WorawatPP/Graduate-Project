...
<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        <form method="post" name="frm" action="activitesupdate.php" enctype="multipart/form-data" id="form1"  >
            <fieldset style="border:3px solid black" class="detail">
            <legend>ยืนยันการบริจาคและจองคิว</legend>
               <table style="font-size:16px; color:black;width: 550px;"align="center">
                               ...
                               <tr>
                                ...
                                <tr><td><input type="submit" class="button" value="ตกลง"></td>
                                    <td><a href="forAdmin4.php"><input type="button" value="ย้อนกลับ" ></a></button></td>
                                    </tr>
                        </table>  
            </fieldset>
        </form>
