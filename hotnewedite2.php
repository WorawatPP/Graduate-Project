...
<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        ...
        <form method="post" name="frm" action="hotnewupdate2.php" enctype="multipart/form-data" id="form1"  >
            ...
            <table style="font-size: 16px;color: black"  border="2" bordercolor="black" align="center">
                 <tr>
                     ...
                     <td>1.หัวข้อข่าว:</td><td><input type="text" name="hotnew_Headline"  placeholder="กรุณาระบุหัวข้อข่าว" value="<?php echo $row['hotnew_Headline']; ?>" size="18"></textarea></td>
                ...
                <td><img src ="img/<?php echo $row['hotnew_Photo']; ?>" width ="160px" height="160px">
                        ...
                        <td><a href="hotnewPhoto2.php?hotnew_ID=<?php echo $row['hotnew_ID']; ?>"><input name="button" type="button" value="แก้ไขรูปภาพ1"></a></td>
                     <td><img src ="img/<?php echo $row['hotnew_Photo2']; ?>" width ="160px" height="160px">
                        </td> 
                        <td><a href="hotnewPhoto2.php?hotnew_ID=<?php echo $row['hotnew_ID']; ?>"><input name="button" type="button" value="แก้ไขรูปภาพ2"></a></td>
                         <td><img src ="img/<?php echo $row['hotnew_Photo3']; ?>" width ="160px" height="160px">
                        </td> 
                        <td><a href="hotnewPhoto2.php?hotnew_ID=<?php echo $row['hotnew_ID']; ?>"><input name="button" type="button" value="แก้ไขรูปภาพ3"></a></td>
                </tr> 
                ...
                <a href="hotnewshow2.php"><input type="button" value="กลับหน้าหลัก"></a>  
