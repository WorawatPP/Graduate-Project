...
<center>
  ...
  <table style="font-size: 16px;width: 80%;border:3px solid black" align="center" border="2">
      <a href="Medicine2.php"><input  type="button" value="ย้อนกลับ"></a>
  <br><br>
              ...
              <th width="150">ชื่อยา</th>
               <th width="150">ชื่อผู้เบิก</th>
               <th width="200">วันที่และเวลา</th>
       ...
       INNER JOIN employee ON employee.Emp_ID = requisition.Emp_ID";
         ...
         <nav>
        <ul class="pagination">
        <a href="Remedicine2.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
        </a>
        <?php for($i=1;$i<=$total_page;$i++){ ?>
        <a href="Remedicine2.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
        <?php } ?>
        <a href="Remedicine2.php?page=<?php echo $total_page;?>" aria-label="Next">
