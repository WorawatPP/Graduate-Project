<html>
    ...
    <script language ="javascript">//เช็คข้อความใน text 
     ...
     <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
         ...
         <form method="post" name="frm" action="Meinsert2.php" enctype="multipart/form-data" id="form1" onsubmit="return check();">
            
            
             <fieldset style="border:3px solid black" class="detail"><legend>เพิ่มข้อมูลยา</legend>
