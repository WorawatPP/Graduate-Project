 ...
 <script language ="javascript">//ตวจสอบค่าว่าง text
    ...
    font-size: 16px;
     ...
     <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
         ...
         <form method="post" name="frm" action="MedicineReInUp2.php" enctype="multipart/form-data" id="form1" onsubmit="return check();">
            
            
             <fieldset style="border:3px solid black" class="detail"><legend>เบิกยา</legend>
            ...
            <tr>
                ...
                <a href="Medicine2.php"><input name="button" type="button" value="ย้อนกลับ"></a>
