...
<center>
    ...
    <a href="TableforEmployeeOld.php"> <input type="button" value="ย้อนกลับ" > </a><br></br>
  ...
  <table style="font-size: 16px;width: 90%;border:3px solid black" align="center" border="2">
            ...
            ?>
                ...
                <td><div align="center"><a href="Olddelete2.php?Op_ID=<?php echo $row['Op_ID']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล')">ลบ</a></div></td>
