...
<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        ...
        <form method="post" name="frm" action="hotnewinsert2.php" class="detail" enctype="multipart/form-data" id="form1" onsubmit="return check();"  >
            ...
            ?>
                   ...
                   <td><div align="center"><a href="hotnewedite2.php?hotnew_ID=<?php echo $row['hotnew_ID'];?>">แก้ไข</a></div></td>
                   <td><div align="center"><a href="hotnewdelet2.php?hotnew_ID=<?php echo $row['hotnew_ID']; ?>"onclick="return confirm('ยืนยันการลบข้อมูล')">ลบ</a></div></td>
