...
<?php
        ...
        /* คำสั่ง SQL ในส่วนนี้ใช้สำหรับ Join ตารางข้อมูลในฐานข้อมูล */
...
<center>
  <table style="font-size: 16px;width: 80%;border:3px solid black" align="center" border="2">
      <a href="Product.php"><input type="button" value="ย้อนกลับ"></a>    
  <br><br>
               <tr>
               <th width="200">ชื่อ</th> <!-- สร้างตารางเพื่อแสดงชื่อสิ่งของ -->
               <th width="200">ชื่อผู้เบิก</th> <!-- สร้างตารางเพื่อแสดงชื่อผู้เบิก -->
               <th width="100">วันที่และเวลา</th> <!-- สร้างตารางเพื่อแสดงวันที่และเวลาเบิกสิ่งของ -->
...
<?php
       ...
       INNER JOIN employee ON employee.Emp_ID = requisitionpd.Emp_ID";
         ...
         <nav>
        <ul class="pagination">
        <a href="Reproduct.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
        </a>
        <?php for($i=1;$i<=$total_page;$i++){ ?>
        <a href="Reproduct.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
        <?php } ?>
        <a href="Reproduct.php?page=<?php echo $total_page;?>" aria-label="Next">
