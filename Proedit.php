<?php
    ...
    $Pd_ID = $_GET['Pd_ID']; /* รับค่า Pd_ID มาจากหน้า TableAdmin3PM.php */
...
<html>
    ...
    <body style="background-image: url(img/bbb1.jpg); background-repeat:repeat;background-attachment:fixed;background-position: center">
        <form method="post" action="Proupdate.php" enctype="multipart/form-data" id="form1">
            ...
            <tr>
                ...
                <a href="TableAdmin3PM.php"><input name="button" type="button" value="ย้อนกลับ"></a>
                </td>
            </tr>
        </table>
            </fieldset
